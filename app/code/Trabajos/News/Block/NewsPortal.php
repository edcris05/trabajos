...
class NewsPortal extends Template {
    ...
    public function __construct(
            ...
            Data $dataHelper,
            \Trabajos\News\Model\CategoryFactory $categoryFactory,
            \Trabajos\News\Model\ArticleFactory $articleFactory,
            StoreManagerInterface $store,
            \Magento\Framework\Stdlib\DateTime\DateTime $dateTime,
            \Trabajos\HelpCenter\Helper\Sanitize $sanitize
            //\DateTime $dateTime
    ) {
        $this->_logger = $logger;
