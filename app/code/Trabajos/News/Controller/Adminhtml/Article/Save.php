...
use Trabajos\News\Model\Article\ImageUploader;
use Trabajos\News\Helper\Data;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Trabajos\News\Model\Article')->load($id);
            if (!$model->getId() && $id) {
    ...
    {
        return $this->_authorization->isAllowed('Trabajos_News::article_update') || $this->_authorization->isAllowed('Trabajos_News::article_create');
    }
}
