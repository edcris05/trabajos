...
class InlineEdit extends \Magento\Backend\App\Action
{
        ...
        if ($this->getRequest()->getParam('isAjax')) {
            ...
            if (!count($postItems)) {
                ...
                foreach (array_keys($postItems) as $categoryId) {
                    /** @var \Trabajos\News\Model\Category $model */
     ...
     * @return string
     */
    protected function getErrorWithCategoryId(\Trabajos\News\Model\Category $category, $errorText)
    {
    ...
    {
        return $this->_authorization->isAllowed('Trabajos_News::category_create') ||
        $this->_authorization->isAllowed('Trabajos_News::category_update');
    }
}
