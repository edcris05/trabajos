...
namespace Trabajos\News\Helper;

use Psr\Log\LoggerInterface;
use Magento\Store\Model\StoreManagerInterface;
use Trabajos\News\Model\Article;
use Trabajos\News\Model\ArticleFactory;
use Trabajos\News\Model\ResourceModel\Article\CollectionFactory as ArticleCollection;
use Trabajos\News\Model\CategoryFactory;
use Trabajos\News\Model\Homenews;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    public function getCategoriesByArticle($articleId = null)
    {
        try {
            ...
            if ($articleId !== null && !empty($articleId)) {
                $query = "SELECT category_id FROM trabajos_news_category_article WHERE article_id='$articleId' ";
            } else {
                $query = "SELECT category_id FROM trabajos_news_category_article ";
            }
    ...
    public function insertCategoryArticle($category,$articleId){
        ...
        $saveQuery = "INSERT INTO trabajos_news_category_article (category_id, article_id) VALUES ('$category','$articleId')"; 
    ...
    public function deleteCategoryArticleByArticle($articleId){
        ...
        try {
            if ($articleId !== null && !empty($articleId)) {
                $resource = $this->_resource->getConnection();
                $query = "DELETE FROM trabajos_news_category_article WHERE article_id='$articleId' "; 
    ...
    public function getArticleByID($articleId)
    {
        try {
            ...
            $query = "SELECT article, answer FROM trabajos_news_article WHERE id='$articleId' ";
    ...
    public function getArticlesidByCategory($categoryID)
    {
        try {
            ...
            if ($categoryID !== null && !empty($categoryID)) {
                $query = "SELECT article_id FROM trabajos_news_category_article WHERE category_id='$categoryID' ";
            } 
            $categories = $resource->fetchAll($query);
